...
Fotavtrykket for Vindturbin registreres som Vindturbinomriss. Vindturbin skal registreres som _ledningsnettverkstype_ hogspent. 
...
[discrete]
==== Tilleggsinformasjon for fotogrammetrisk registrering
Omriss av Vindturbin. Vindturbinomriss skal registreres som _ledningsnettverkstype_ hogspent.
